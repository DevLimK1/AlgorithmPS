...
//https://m.blog.naver.com/PostView.nhn?blogId=yongyos&logNo=221572139348&proxyReferer=https:%2F%2Fwww.google.com%2F
public class 스킬트리 {
        public int solution(String skill, String[] skill_trees) {
            ...
            for (int i = 0; i < skill_trees.length; i++) {
                ...
                for (int j = 1; j < skill.length(); j++) {
                    //beforeIdx 이후 index를 currentIdx에 담는다.
                    currentIdx = skill_trees[i].indexOf(skill.charAt(j));
                    //skill에 해당하는 순차적인 인덱스가 더 크면 안된다.
